...
const university = process.env.NEXT_PUBLIC_UNIVERSITY || 'URTK';

// Определяем названия в зависимости от университета
const universityName = university === 'RGSU' ? 'РГСУ' : 'УРТК';
const universityFullName = university === 'RGSU'
    ? 'Российского государственного социального университета'
    : 'Уральского Радиотехнического Колледжа им. А.С. Попова';

// Создаем манифест
const manifest = {
    "name": `Академикс — расписание ${universityName}`,
    "short_name": "Академикс",
    "description": `Платформа для просмотра расписание СПО и ВУЗов. Расписания ${universityFullName}.`,
    "icons": [
        {
...
const manifestPath = path.join(__dirname, 'src', 'app', 'manifest.json');
fs.writeFileSync(manifestPath, JSON.stringify(manifest, null, 2));

console.log(`✅ Манифест сгенерирован для ${universityName} (${university})`);
console.log(`📁 Файл сохранен: ${manifestPath}`);
